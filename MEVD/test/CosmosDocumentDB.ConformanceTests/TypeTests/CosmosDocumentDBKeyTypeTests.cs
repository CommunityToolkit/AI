...
public class CosmosDocumentDBKeyTypeTests(CosmosDocumentDBKeyTypeTests.Fixture fixture)
    : KeyTypeTests(fixture), IClassFixture<CosmosDocumentDBKeyTypeTests.Fixture>
{
    [Fact]
