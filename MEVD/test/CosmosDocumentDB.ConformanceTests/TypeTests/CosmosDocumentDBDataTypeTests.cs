...
public class CosmosDocumentDBDataTypeTests(CosmosDocumentDBDataTypeTests.Fixture fixture)
    : DataTypeTests<string, DataTypeTests<string>.DefaultRecord>(fixture), IClassFixture<CosmosDocumentDBDataTypeTests.Fixture>
{
