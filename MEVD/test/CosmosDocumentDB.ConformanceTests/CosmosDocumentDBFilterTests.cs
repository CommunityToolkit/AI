...
public class CosmosDocumentDBFilterTests(CosmosDocumentDBFilterTests.Fixture fixture)
    : FilterTests<string>(fixture), IClassFixture<CosmosDocumentDBFilterTests.Fixture>
{
    ...
    // CosmosDocumentDB filter translator doesn't support Enumerable.Any or Enumerable.Contains/MemoryExtensions.Contains
