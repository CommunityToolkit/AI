...
public static class CosmosDocumentDBTestEnvironment
{
    public static readonly string? ConnectionString;

    public static bool IsConnectionStringDefined => ConnectionString is not null;

    static CosmosDocumentDBTestEnvironment()
    {
        var configuration = new ConfigurationBuilder()
            .AddJsonFile(path: "testsettings.json", optional: true)
            .AddJsonFile(path: "testsettings.development.json", optional: true)
            .AddEnvironmentVariables()
            .AddUserSecrets<CosmosDocumentDBTestStore>()
            .Build();

        ConnectionString = configuration["CosmosDocumentDB:ConnectionString"];
    }
}
