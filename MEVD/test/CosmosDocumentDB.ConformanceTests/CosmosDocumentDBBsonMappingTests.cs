...
public sealed class CosmosDocumentDBBsonMappingTests(CosmosDocumentDBBsonMappingTests.Fixture fixture)
    : IClassFixture<CosmosDocumentDBBsonMappingTests.Fixture>
{
    [Fact]
    public async Task Upsert_with_bson_model_works()
    {
        var store = (CosmosDocumentDBTestStore)fixture.TestStore;
        ...
        using var collection = new CosmosDocumentDBCollection<string, BsonTestModel>(
            store.Database,
            collectionName,
    ...
    public async Task Upsert_with_bson_vector_store_model_works()
    {
        ...
        using var collection = new CosmosDocumentDBCollection<string, BsonVectorStoreTestModel>(store.Database, collectionName);
    ...
    public async Task Upsert_with_bson_vector_store_with_name_model_works()
    {
        ...
        using var collection = new CosmosDocumentDBCollection<string, BsonVectorStoreWithNameTestModel>(store.Database, collectionName);
