...
namespace CommunityToolkit.VectorData.AzureCosmosDB.UnitTests;

public sealed class CosmosDBOptionsTests
{
    [Fact]
    public void CollectionOptionsPropertiesCanBeConfigured()
    {
        ...
        CosmosDBCollectionOptions source = new()
        {
    ...
    {
        JsonSerializerOptions serializerOptions = new(JsonSerializerDefaults.Web);
        CosmosDBVectorStoreOptions source = new()
        {
            JsonSerializerOptions = serializerOptions,
        };
