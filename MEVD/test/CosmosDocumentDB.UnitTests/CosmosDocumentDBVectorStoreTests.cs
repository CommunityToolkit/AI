...
/// <summary>
/// Unit tests for <see cref="CosmosDocumentDBVectorStore"/> class.
/// </summary>
public sealed class CosmosDocumentDBVectorStoreTests
{
    ...
    {
        // Arrange
        using var sut = new CosmosDocumentDBVectorStore(this._mockMongoDatabase.Object);

        // Act & Assert
        Assert.Throws<NotSupportedException>(() => sut.GetCollection<byte[], CosmosDocumentDBHotelModel>("collection"));
    }
    ...
    public void GetCollectionWithoutFactoryReturnsDefaultCollection()
    {
        ...
        // Act
        var collection = sut.GetCollection<string, CosmosDocumentDBHotelModel>("collection");
