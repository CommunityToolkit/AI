...
public class AzureDocumentDBMultiVectorModelTests(AzureDocumentDBMultiVectorModelTests.Fixture fixture)
    : MultiVectorModelTests<string>(fixture), IClassFixture<AzureDocumentDBMultiVectorModelTests.Fixture>
{
