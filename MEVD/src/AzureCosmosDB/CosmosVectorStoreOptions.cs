...
/// <summary>
/// Options when creating a <see cref="CosmosVectorStore"/>.
/// </summary>
public sealed class CosmosVectorStoreOptions
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CosmosVectorStoreOptions"/> class.
    /// </summary>
    public CosmosVectorStoreOptions()
    {
    }

    internal CosmosVectorStoreOptions(CosmosVectorStoreOptions? source)
    {
