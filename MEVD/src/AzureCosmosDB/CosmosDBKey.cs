...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CosmosDBKey"/> struct with a document ID and partition key.
    /// </summary>
    /// <param name="documentId">The document ID.</param>
    /// <param name="partitionKey">The Cosmos DB partition key.</param>
    public CosmosDBKey(string documentId, string partitionKey)
    {
    ...
    /// <param name="documentId">The document ID.</param>
    /// <param name="partitionKey">The Cosmos DB partition key.</param>
    public CosmosDBKey(Guid documentId, string partitionKey)
    {
    ...
    /// <param name="documentId">The document ID.</param>
    /// <param name="partitionKey">The Cosmos DB partition key.</param>
    public CosmosDBKey(string documentId, Guid partitionKey)
    {
        this.DocumentId = documentId;
    ...
    /// <param name="documentId">The document ID.</param>
    /// <param name="partitionKey">The Cosmos DB partition key.</param>
    public CosmosDBKey(Guid documentId, Guid partitionKey)
    {
        this.DocumentId = documentId.ToString();
        this.PartitionKey = new PartitionKey(partitionKey.ToString());
    }
    ...
    /// <param name="documentId">The document ID.</param>
    /// <param name="partitionKey">The Cosmos DB partition key.</param>
    public CosmosDBKey(string documentId, bool partitionKey)
    {
        this.DocumentId = documentId;
        this.PartitionKey = new PartitionKey(partitionKey);
    }
    ...
    /// <param name="documentId">The document ID.</param>
    /// <param name="partitionKey">The Cosmos DB partition key.</param>
    public CosmosDBKey(Guid documentId, bool partitionKey)
    {
        this.DocumentId = documentId.ToString();
        this.PartitionKey = new PartitionKey(partitionKey);
    }
    ...
    /// <param name="documentId">The document ID.</param>
    /// <param name="partitionKey">The Cosmos DB partition key.</param>
    public CosmosDBKey(string documentId, double partitionKey)
    {
        this.DocumentId = documentId;
        this.PartitionKey = new PartitionKey(partitionKey);
    }
    ...
    /// <param name="documentId">The document ID.</param>
    /// <param name="partitionKey">The Cosmos DB partition key.</param>
    public CosmosDBKey(Guid documentId, double partitionKey)
    {
        this.DocumentId = documentId.ToString();
        this.PartitionKey = new PartitionKey(partitionKey);
    }
    ...
    /// </remarks>
    public CosmosDBKey(string documentId, PartitionKey partitionKey)
    {
        this.DocumentId = documentId;
    ...
    /// For hierarchical partition keys, construct the <see cref="PartitionKey"/> using <see cref="PartitionKeyBuilder"/>.
    /// </remarks>
    public CosmosDBKey(Guid documentId, PartitionKey partitionKey)
    {
        this.DocumentId = documentId.ToString();
        this.PartitionKey = partitionKey;
    }
    ...
    /// <summary>
    /// Determines whether two <see cref="CosmosDBKey"/> instances are equal.
    /// </summary>
    public static bool operator ==(CosmosDBKey left, CosmosDBKey right)
        => left.Equals(right);

    /// <summary>
    /// Determines whether two <see cref="CosmosDBKey"/> instances are not equal.
    /// </summary>
    public static bool operator !=(CosmosDBKey left, CosmosDBKey right)
        => !left.Equals(right);
}
