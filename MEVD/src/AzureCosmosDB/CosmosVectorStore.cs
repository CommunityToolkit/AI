...
/// <summary>
/// Class for accessing the list of collections in a Azure Cosmos NoSQL vector store.
/// </summary>
/// <remarks>
/// This class can be used with collections of any schema type, but requires you to provide schema information when getting a collection.
/// </remarks>
public sealed class CosmosVectorStore : VectorStore
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CosmosVectorStore"/> class.
    /// </summary>
    ...
    public CosmosVectorStore(Database database, CosmosVectorStoreOptions? options = null)
    ...
    public CosmosVectorStore(string connectionString, string databaseName,
        CosmosClientOptions? clientOptions = null, CosmosVectorStoreOptions? storeOptions = null)
    ...
    private CosmosVectorStore(ClientWrapper clientWrapper,
        Func<CosmosClient, Database> databaseProvider, CosmosVectorStoreOptions? options)
    {
        try
        {
...
#pragma warning disable IDE0090 // Use 'new(...)'
    ...
    [RequiresDynamicCode("The Cosmos NoSQL provider is currently incompatible with NativeAOT.")]
#if NET
    public override CosmosCollection<TKey, TRecord> GetCollection<TKey, TRecord>(string name, VectorStoreCollectionDefinition? definition = null)
#else
    ...
    [RequiresDynamicCode("The Cosmos NoSQL provider is currently incompatible with NativeAOT.")]
#if NET
    public override CosmosDynamicCollection GetDynamicCollection(string name, VectorStoreCollectionDefinition definition)
#else
