...
/// <summary>
/// Represents a key for Azure Cosmos NoSQL, containing both the record key (document ID) and the partition key.
/// </summary>
/// <remarks>
/// <para>
...
public readonly struct CosmosKey : IEquatable<CosmosKey>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CosmosKey"/> struct with a document ID and partition key.
    /// </summary>
    /// <param name="documentId">The document ID.</param>
    /// <param name="partitionKey">The Cosmos DB partition key.</param>
    public CosmosKey(string documentId, string partitionKey)
    {
    ...
    /// <param name="documentId">The document ID.</param>
    /// <param name="partitionKey">The Cosmos DB partition key.</param>
    public CosmosKey(Guid documentId, string partitionKey)
    {
    ...
    /// <param name="documentId">The document ID.</param>
    /// <param name="partitionKey">The Cosmos DB partition key.</param>
    public CosmosKey(string documentId, Guid partitionKey)
    {
        this.DocumentId = documentId;
    ...
    /// <param name="documentId">The document ID.</param>
    /// <param name="partitionKey">The Cosmos DB partition key.</param>
    public CosmosKey(Guid documentId, Guid partitionKey)
    {
        this.DocumentId = documentId.ToString();
        this.PartitionKey = new PartitionKey(partitionKey.ToString());
    }
    ...
    /// <param name="documentId">The document ID.</param>
    /// <param name="partitionKey">The Cosmos DB partition key.</param>
    public CosmosKey(string documentId, bool partitionKey)
    {
        this.DocumentId = documentId;
        this.PartitionKey = new PartitionKey(partitionKey);
    }
    ...
    /// <param name="documentId">The document ID.</param>
    /// <param name="partitionKey">The Cosmos DB partition key.</param>
    public CosmosKey(Guid documentId, bool partitionKey)
    {
        this.DocumentId = documentId.ToString();
        this.PartitionKey = new PartitionKey(partitionKey);
    }
    ...
    /// <param name="documentId">The document ID.</param>
    /// <param name="partitionKey">The Cosmos DB partition key.</param>
    public CosmosKey(string documentId, double partitionKey)
    {
        this.DocumentId = documentId;
        this.PartitionKey = new PartitionKey(partitionKey);
    }
    ...
    /// <param name="documentId">The document ID.</param>
    /// <param name="partitionKey">The Cosmos DB partition key.</param>
    public CosmosKey(Guid documentId, double partitionKey)
    {
        this.DocumentId = documentId.ToString();
        this.PartitionKey = new PartitionKey(partitionKey);
    }
    ...
    /// </remarks>
    public CosmosKey(string documentId, PartitionKey partitionKey)
    {
        this.DocumentId = documentId;
    ...
    /// For hierarchical partition keys, construct the <see cref="PartitionKey"/> using <see cref="PartitionKeyBuilder"/>.
    /// </remarks>
    public CosmosKey(Guid documentId, PartitionKey partitionKey)
    {
        this.DocumentId = documentId.ToString();
        this.PartitionKey = partitionKey;
    }
    ...
    /// <summary>
    /// Determines whether two <see cref="CosmosKey"/> instances are equal.
    /// </summary>
    public static bool operator ==(CosmosKey left, CosmosKey right)
        => left.Equals(right);

    /// <summary>
    /// Determines whether two <see cref="CosmosKey"/> instances are not equal.
    /// </summary>
    public static bool operator !=(CosmosKey left, CosmosKey right)
        => !left.Equals(right);
}
