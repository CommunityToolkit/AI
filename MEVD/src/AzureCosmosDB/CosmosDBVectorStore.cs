...
/// </remarks>
public sealed class CosmosDBVectorStore : VectorStore
{
    ...
    public CosmosDBVectorStore(Database database, CosmosDBVectorStoreOptions? options = null)
    ...
    public CosmosDBVectorStore(string connectionString, string databaseName,
        CosmosClientOptions? clientOptions = null, CosmosDBVectorStoreOptions? storeOptions = null)
    ...
    private CosmosDBVectorStore(ClientWrapper clientWrapper,
        Func<CosmosClient, Database> databaseProvider, CosmosDBVectorStoreOptions? options)
    {
        try
        {
...
#pragma warning disable IDE0090 // Use 'new(...)'
    ...
    [RequiresDynamicCode("The Cosmos NoSQL provider is currently incompatible with NativeAOT.")]
#if NET
    public override CosmosDBCollection<TKey, TRecord> GetCollection<TKey, TRecord>(string name, VectorStoreCollectionDefinition? definition = null)
#else
    public override VectorStoreCollection<TKey, TRecord> GetCollection<TKey, TRecord>(string name, VectorStoreCollectionDefinition? definition = null)
#endif
        => typeof(TRecord) == typeof(Dictionary<string, object?>)
            ? throw new ArgumentException(VectorDataStrings.GetCollectionWithDictionaryNotSupported)
            : new CosmosDBCollection<TKey, TRecord>(
    ...
    [RequiresDynamicCode("The Cosmos NoSQL provider is currently incompatible with NativeAOT.")]
#if NET
    public override CosmosDBDynamicCollection GetDynamicCollection(string name, VectorStoreCollectionDefinition definition)
#else
    public override VectorStoreCollection<object, Dictionary<string, object?>> GetDynamicCollection(string name, VectorStoreCollectionDefinition definition)
#endif
        => new CosmosDBDynamicCollection(
            this._clientWrapper.Share(),
            _ => this._database,
            name,
            new()
