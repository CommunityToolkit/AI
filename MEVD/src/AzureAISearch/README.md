...
1. Create an Azure AI Search instance via the [Azure portal](https://learn.microsoft.com/azure/search/search-create-service-portal) or [Azure CLI](https://learn.microsoft.com/azure/search/search-manage-azure-cli).
