...
public static class WeaviateServiceCollectionExtensions
{
        ...
        ServiceLifetime lifetime = ServiceLifetime.Singleton)
    {
        ...
        {
            var client = GetHttpClient(clientProvider?.Invoke(sp), sp);
        ...
        ServiceLifetime lifetime = ServiceLifetime.Singleton)
    {
        ...
        return AddKeyedWeaviateVectorStore(services, serviceKey, sp => GetHttpClient(null, sp), sp => copy, lifetime);
    }
        ...
        where TRecord : class
    {
        ...
        return AddKeyedWeaviateCollection<TRecord>(services, serviceKey, name, sp => GetHttpClient(null, sp), sp => copy, lifetime);
    }
    ...
    private static HttpClient GetHttpClient(HttpClient? httpClient, IServiceProvider sp)
