...
/// <summary>
/// Options when creating a <see cref="CosmosDocumentDBCollection{TKey, TRecord}"/>.
/// </summary>
public sealed class CosmosDocumentDBCollectionOptions : VectorStoreCollectionOptions
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CosmosDocumentDBCollectionOptions"/> class.
    /// </summary>
