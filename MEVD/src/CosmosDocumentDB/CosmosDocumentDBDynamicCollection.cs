...
public sealed class CosmosDocumentDBDynamicCollection : CosmosDocumentDBCollection<object, Dictionary<string, object?>>
#pragma warning restore CA1711 // Identifiers should not have incorrect suffix
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CosmosDocumentDBDynamicCollection"/> class.
    /// </summary>
    ...
    public CosmosDocumentDBDynamicCollection(IMongoDatabase mongoDatabase, string name, CosmosDocumentDBCollectionOptions options)
        : base(
            mongoDatabase,
            name,
