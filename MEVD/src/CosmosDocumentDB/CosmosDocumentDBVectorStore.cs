...
/// <summary>
/// Class for accessing the list of collections in a Azure DocumentDB vector store.
/// </summary>
/// <remarks>
/// This class can be used with collections of any schema type, but requires you to provide schema information when getting a collection.
/// </remarks>
public sealed class CosmosDocumentDBVectorStore : VectorStore
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CosmosDocumentDBVectorStore"/> class.
    /// </summary>
    ...
    public CosmosDocumentDBVectorStore(IMongoDatabase mongoDatabase, CosmosDocumentDBVectorStoreOptions? options = default)
    {
...
#pragma warning disable IDE0090 // Use 'new(...)'
...
#if NET
    public override CosmosDocumentDBCollection<TKey, TRecord> GetCollection<TKey, TRecord>(string name, VectorStoreCollectionDefinition? definition = null)
#else
    public override VectorStoreCollection<TKey, TRecord> GetCollection<TKey, TRecord>(string name, VectorStoreCollectionDefinition? definition = null)
#endif
        => typeof(TRecord) == typeof(Dictionary<string, object?>)
            ? throw new ArgumentException(VectorDataStrings.GetCollectionWithDictionaryNotSupported)
            : new CosmosDocumentDBCollection<TKey, TRecord>(
                _mongoDatabase,
                name,
                new()
                {
    ...
    /// <inheritdoc />
#if NET
    public override CosmosDocumentDBDynamicCollection GetDynamicCollection(string name, VectorStoreCollectionDefinition definition)
#else
    public override VectorStoreCollection<object, Dictionary<string, object?>> GetDynamicCollection(string name, VectorStoreCollectionDefinition definition)
#endif
        => new CosmosDocumentDBDynamicCollection(
            _mongoDatabase,
            name,
            new()
            {
...
#pragma warning restore IDE0090
    ...
    public override async IAsyncEnumerable<string> ListCollectionNamesAsync([EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        using var cursor = await VectorStoreErrorHandler.RunOperationAsync<IAsyncCursor<string>, MongoException>(
            _metadata,
            OperationName,
            () => _mongoDatabase.ListCollectionNamesAsync(cancellationToken: cancellationToken)).ConfigureAwait(false);
